...
parser.add_argument('--day', action='append', help='Monday, Tuesday, Wednesday, Thursday, Friday; multiple uses allowed')
...
possible_classes, no_classes = schedule(args.day)
